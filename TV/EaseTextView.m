...
//    NSLog(@"%d", [EaseTextView maxCharactersPerLine]);
...
//    if ([self.delegate respondsToSelector:@selector(textViewHeight:height:)]) {
//        [self.delegate textViewHeight:self height:[self numberOfLinesOfText] * self.font.pointSize];
//    }
    [self setNeedsDisplay];
}
